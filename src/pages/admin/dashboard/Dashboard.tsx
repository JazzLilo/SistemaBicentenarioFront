...
export const Dashboard = () => {
  const [activeTab, setActiveTab] = useState<'users' | 'eventos' |'dashboard' | 'events' | 'history' | 'library' | 'comments' | 'statistics' | 'news' | 'cultura' | 'presidentes'>('dashboard')
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'eventos': return <EventosManagement />
