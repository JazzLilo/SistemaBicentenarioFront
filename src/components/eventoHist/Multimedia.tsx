  ...
  const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      setNewItem({
        ...
        file,
        url: undefined,
        preview: newItem.tipo === 'imagen' ? preview : undefined
      });
    }
  };
  ...
  const handleSaveItem = async () => {
    ...
    try {
      ...
      if (editingItem) {
        ...
        await apiService.post('multimedia', {
          url: fileUrl,
          tipo: newItem.tipo,
            ...
            {newItem.method === 'url' ? (
              <div className="flex flex-col gap-2">
                <Input
                  ...
                  placeholder={`https://ejemplo.com/${newItem.tipo === 'imagen' ? 'imagen.jpg' : 'video.mp4'}`}
                />
              ...
              <div className="flex flex-col gap-2">
                ...
                {newItem.file && newItem.tipo === 'video' && (
                  <div className="mt-2">
