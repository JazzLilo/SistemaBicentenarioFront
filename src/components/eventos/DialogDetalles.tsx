...
export const DialogDetalles = ({ open, onOpenChange, evento }: DialogProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-[70vw] max-w-4xl h-[90vh] flex flex-col p-0 rounded-lg overflow-hidden">
                <div className="flex flex-col h-full">
                    <DialogHeader className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6">
                        ...
                        <DialogDescription className="text-blue-100">
                            Información completa y edición del evento seleccionado.
                        </DialogDescription>
                    </DialogHeader>
